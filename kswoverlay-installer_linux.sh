...
menu(){
	...
	echo  [3] Enable KswOverlay
	echo  [4] Disable KswOverlay
	echo  [5] Reboot device
	echo  [6] Reveal factory passcode
	echo  [7] Enable safe media bypass \(100% volume after reboot\)
	echo  [0] Exit
	echo  " "
...
menu_options(){
	...
	case $choice in
		...
		3) clear; enableKSWmanual ;;
		4) clear; disableKSW ;;
		5) clear; rebootdevice ;;
		6) clear; get_passcode ;;
		7) clear; enable_safe_media_bypass;;
		0) exit 0;;
